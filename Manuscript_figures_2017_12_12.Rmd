...
```{r}
#Set working directory to where IBMsummary.csv is located
#setwd()
...
tiff("FigureS2.tiff", height = 11.5, width = 14, units = "in", compression = "lzw", res = 300)
multiplot(gg,hh, cols=1)
dev.off()

```

## Supplementary Figure 3 (Heat map)
...
tiff("FigureS3_heatmap.tiff", height = 18, width = 14, units = "in", compression = "lzw", res = 300)
multiplot(hh,gg, ii,jj, cols=1)
dev.off()
```

## Supplementary Figure 1 
Calibrate beta1/beta2/beta3
```{r}
