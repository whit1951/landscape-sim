...
setwd("C:/Users/law2y/OneDrive/R Code/LandscapeCh/Figures May 2018")
...
tiff("Figure3new.tiff", height = 22.7, width = 17.8, units = "cm", compression = "lzw", res = 900)
...
```{r}
setwd("C:/Users/law2y/OneDrive/R Code/LandscapeCh/Random Forest Party Package May 2018")
...
setwd("C:/Users/law2y/OneDrive/R Code/LandscapeCh/Figures May 2018")
tiff("FigureS1_party.tiff", height =4.5, width =8.7, units = "cm", compression = "lzw", res = 1200)
#multiplot(A, B, C, cols=3)
prow
dev.off()
...
## Supplementary Figure S3 (Heat maps, density=0.25)
...
## Supplementary Figure S4 (Heat maps, density=0.5)
...
tiff("FigureS5.tiff", height = 22.5, width = 17.8, units = "cm", compression = "lzw", res = 900)
multiplot(ii,jj, cols=1)
dev.off()
```

##Figure S5 (log version)
```{r}
#percep=3, rec_rate=0.2, density=0.5
p3r0.2d0.5<-merged_data[which(merged_data$percep==3 & merged_data$rec_rate==0.2 & merged_data$density==0.5),]
...
tiff("FigS5_log.tiff", height = 11.5, width = 14, units = "in", compression = "lzw", res = 300)
multiplot(ii,jj, cols=1)
dev.off()
```
...
tiff("FigureS6.tiff", height = 22, width = 17.8, units = "cm", compression = "lzw", res = 1200)
...
##Supplementary Figure S8: Calibrating beta2/beta3 for RSF
```{r}
...
#Now make the map
tiff("FigureS9_p_vs_H.tif", height = 8.7, width = 8.7, units = "cm", compression = "lzw", res = 900)
